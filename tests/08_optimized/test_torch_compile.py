...
def test_compiled_model_matches_eager_output():
    ...
    Objectif
    --------
    Spécifier clairement la connaissance: compiled model matches eager output.
    ...
    -----------------------
    Le comportement lié à torch.compile doit être observable avec un exemple minimal et déterministe.
    ...
    ----------------------
    Commencer avec torch.manual_seed(0), de petits tenseurs CPU et torch.testing.assert_close si flottant. Code cible: compilation helper.
