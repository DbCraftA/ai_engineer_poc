...
def test_nanochat_like_model_can_generate_tokens():
    ...
    Objectif
    --------
    Spécifier clairement la connaissance: nanochat like model can generate tokens.
    ...
    -----------------------
    Le comportement lié à génération doit être observable avec un exemple minimal et déterministe.
    ...
    ----------------------
    Commencer avec torch.manual_seed(0), de petits tenseurs CPU et torch.testing.assert_close si flottant. Code cible: generation.
