...
def test_gpu_matmul_matches_cpu_reference():
    ...
    Objectif
    --------
    Spécifier clairement la connaissance: gpu matmul matches cpu reference.
    ...
    -----------------------
    Le comportement lié à GEMM/GEMV doit être observable avec un exemple minimal et déterministe.
    ...
    ----------------------
    Commencer avec torch.manual_seed(0), de petits tenseurs CPU et torch.testing.assert_close si flottant. Code cible: benchmark only.
