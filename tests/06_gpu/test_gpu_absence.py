...
def test_gpu_marked_tests_skip_cleanly_without_cuda():
    ...
    Objectif
    --------
    Spécifier clairement la connaissance: gpu marked tests skip cleanly without cuda.
    ...
    -----------------------
    Le comportement lié à GPU absence doit être observable avec un exemple minimal et déterministe.
    ...
    ----------------------
    Commencer avec torch.manual_seed(0), de petits tenseurs CPU et torch.testing.assert_close si flottant. Code cible: tests/conftest.py.
