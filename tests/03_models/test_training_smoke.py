...
def test_tiny_model_can_reduce_loss_on_tiny_dataset():
    ...
    Objectif
    --------
    Spécifier clairement la connaissance: tiny model can reduce loss on tiny dataset.
    ...
    -----------------------
    Le comportement lié à training minimal doit être observable avec un exemple minimal et déterministe.
    ...
    ----------------------
    Commencer avec torch.manual_seed(0), de petits tenseurs CPU et torch.testing.assert_close si flottant. Code cible: src/inference_lab/training/.
