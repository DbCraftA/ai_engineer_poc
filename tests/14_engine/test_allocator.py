...
def test_block_allocator_reuses_released_blocks():
    ...
    Objectif
    --------
    Spécifier clairement la connaissance: block allocator reuses released blocks.
    ...
    -----------------------
    Le comportement lié à fragmentation doit être observable avec un exemple minimal et déterministe.
    ...
    ----------------------
    Commencer avec torch.manual_seed(0), de petits tenseurs CPU et torch.testing.assert_close si flottant. Code cible: allocator.
