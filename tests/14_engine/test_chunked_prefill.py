...
def test_long_prefill_can_be_split_into_multiple_chunks():
    ...
    Objectif
    --------
    Spécifier clairement la connaissance: long prefill can be split into multiple chunks.
    ...
    -----------------------
    Le comportement lié à chunked prefill doit être observable avec un exemple minimal et déterministe.
