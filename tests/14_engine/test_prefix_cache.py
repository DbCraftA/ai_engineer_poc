...
def test_identical_prefix_can_reuse_cached_kv_blocks():
    ...
    Objectif
    --------
    Spécifier clairement la connaissance: identical prefix can reuse cached kv blocks.
    ...
    -----------------------
    Le comportement lié à prefix caching doit être observable avec un exemple minimal et déterministe.
    ...
    ----------------------
    Commencer avec torch.manual_seed(0), de petits tenseurs CPU et torch.testing.assert_close si flottant. Code cible: prefix cache.
