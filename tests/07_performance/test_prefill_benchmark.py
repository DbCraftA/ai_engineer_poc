...
def test_prefill_benchmark_reports_latency_and_input_tokens_per_second():
    ...
    Objectif
    --------
    Spécifier clairement la connaissance: prefill benchmark reports latency and input tokens per second.
    ...
    -----------------------
    Le comportement lié à prefill metrics doit être observable avec un exemple minimal et déterministe.
