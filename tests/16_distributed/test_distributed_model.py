...
def test_tensor_parallel_model_matches_single_device_reference():
    ...
    Objectif
    --------
    Spécifier clairement la connaissance: tensor parallel model matches single device reference.
    ...
    -----------------------
    Le comportement lié à distributed model doit être observable avec un exemple minimal et déterministe.
