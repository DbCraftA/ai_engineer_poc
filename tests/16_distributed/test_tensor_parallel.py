...
def test_column_parallel_linear_reconstructs_reference_output():
    ...
    Objectif
    --------
    Spécifier clairement la connaissance: column parallel linear reconstructs reference output.
    ...
    -----------------------
    Le comportement lié à column parallel doit être observable avec un exemple minimal et déterministe.
...
def test_row_parallel_linear_reconstructs_reference_output():
    ...
    Objectif
    --------
    Spécifier clairement la connaissance: row parallel linear reconstructs reference output.
    ...
    Comportement à vérifier
    -----------------------
    Le comportement lié à row parallel doit être observable avec un exemple minimal et déterministe.
