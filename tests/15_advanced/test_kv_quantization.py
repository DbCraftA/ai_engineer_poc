...
def test_quantized_kv_cache_reduces_cache_memory():
    ...
    Objectif
    --------
    Spécifier clairement la connaissance: quantized kv cache reduces cache memory.
    ...
    -----------------------
    Le comportement lié à KV quantization doit être observable avec un exemple minimal et déterministe.
    ...
    ----------------------
    Commencer avec torch.manual_seed(0), de petits tenseurs CPU et torch.testing.assert_close si flottant. Code cible: future KV quantization.
