...
def test_our_rmsnorm_matches_qwen_reference():
    ...
    Objectif
    --------
    Spécifier clairement la connaissance: our rmsnorm matches qwen reference.
    ...
    -----------------------
    Le comportement lié à RMSNorm Qwen doit être observable avec un exemple minimal et déterministe.
