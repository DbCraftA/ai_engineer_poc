...
def test_our_rope_matches_qwen_reference():
    ...
    Objectif
    --------
    Spécifier clairement la connaissance: our rope matches qwen reference.
    ...
    -----------------------
    Le comportement lié à RoPE Qwen doit être observable avec un exemple minimal et déterministe.
    ...
    ----------------------
    Commencer avec torch.manual_seed(0), de petits tenseurs CPU et torch.testing.assert_close si flottant. Code cible: Qwen components.
