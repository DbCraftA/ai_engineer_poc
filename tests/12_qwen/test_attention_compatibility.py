...
def test_our_gqa_matches_qwen_reference_on_small_input():
    ...
    Objectif
    --------
    Spécifier clairement la connaissance: our gqa matches qwen reference on small input.
    ...
    -----------------------
    Le comportement lié à GQA Qwen doit être observable avec un exemple minimal et déterministe.
    ...
    ----------------------
    Commencer avec torch.manual_seed(0), de petits tenseurs CPU et torch.testing.assert_close si flottant. Code cible: Qwen attention.
