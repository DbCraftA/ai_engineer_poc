...
def test_cuda_backend_matches_cpu_reference():
    ...
    Objectif
    --------
    Spécifier clairement la connaissance: cuda backend matches cpu reference.
    ...
    -----------------------
    Le comportement lié à CUDA backend doit être observable avec un exemple minimal et déterministe.
