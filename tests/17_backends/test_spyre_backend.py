...
def test_spyre_backend_matches_reference_for_supported_operation():
    ...
    Objectif
    --------
    Spécifier clairement la connaissance: spyre backend matches reference for supported operation.
    ...
    -----------------------
    Le comportement lié à Spyre backend doit être observable avec un exemple minimal et déterministe.
