...
def test_supported_backends_produce_numerically_compatible_results():
    ...
    Objectif
    --------
    Spécifier clairement la connaissance: supported backends produce numerically compatible results.
    ...
    -----------------------
    Le comportement lié à cross-hardware doit être observable avec un exemple minimal et déterministe.
