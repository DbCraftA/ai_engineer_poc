...
def test_cpu_backend_executes_reference_operation():
    ...
    Objectif
    --------
    Spécifier clairement la connaissance: cpu backend executes reference operation.
    ...
    -----------------------
    Le comportement lié à CPU backend doit être observable avec un exemple minimal et déterministe.
