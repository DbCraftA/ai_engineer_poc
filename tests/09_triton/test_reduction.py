...
def test_triton_reduction_matches_pytorch():
    ...
    Objectif
    --------
    Spécifier clairement la connaissance: triton reduction matches pytorch.
    ...
    -----------------------
    Le comportement lié à reduction doit être observable avec un exemple minimal et déterministe.
    ...
    ----------------------
    Commencer avec torch.manual_seed(0), de petits tenseurs CPU et torch.testing.assert_close si flottant. Code cible: src/inference_lab/kernels/triton/reduction.py.
