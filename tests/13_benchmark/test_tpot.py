...
def test_tpot_metric_measures_decode_time_per_output_token():
    ...
    Objectif
    --------
    Spécifier clairement la connaissance: tpot metric measures decode time per output token.
    ...
    -----------------------
    Le comportement lié à TPOT doit être observable avec un exemple minimal et déterministe.
    ...
    ----------------------
    Commencer avec torch.manual_seed(0), de petits tenseurs CPU et torch.testing.assert_close si flottant. Code cible: metrics.
