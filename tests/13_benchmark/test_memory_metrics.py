...
def test_benchmark_reports_peak_device_memory():
    ...
    Objectif
    --------
    Spécifier clairement la connaissance: benchmark reports peak device memory.
    ...
    -----------------------
    Le comportement lié à mémoire doit être observable avec un exemple minimal et déterministe.
