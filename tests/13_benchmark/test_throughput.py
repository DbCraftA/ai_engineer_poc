...
def test_throughput_reports_tokens_per_second():
    ...
    Objectif
    --------
    Spécifier clairement la connaissance: throughput reports tokens per second.
    ...
    -----------------------
    Le comportement lié à throughput doit être observable avec un exemple minimal et déterministe.
