...
def test_ttft_metric_measures_time_until_first_token():
    ...
    Objectif
    --------
    Spécifier clairement la connaissance: ttft metric measures time until first token.
    ...
    -----------------------
    Le comportement lié à TTFT doit être observable avec un exemple minimal et déterministe.
