...
def test_custom_llm_can_select_naive_or_sdpa_attention():
    ...
    Objectif
    --------
    Spécifier clairement la connaissance: custom llm can select naive or sdpa attention.
    ...
    -----------------------
    Le comportement lié à attention backend doit être observable avec un exemple minimal et déterministe.
...
def test_equivalent_attention_backends_produce_close_outputs():
    ...
    Objectif
    --------
    Spécifier clairement la connaissance: equivalent attention backends produce close outputs.
    ...
    Comportement à vérifier
    -----------------------
    Le comportement lié à comportement identique doit être observable avec un exemple minimal et déterministe.
