...
def test_custom_llm_can_select_normalization_implementation():
    ...
    Objectif
    --------
    Spécifier clairement la connaissance: custom llm can select normalization implementation.
    ...
    -----------------------
    Le comportement lié à normalisation configurable doit être observable avec un exemple minimal et déterministe.
