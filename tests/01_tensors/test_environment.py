...
def test_pytorch_is_available():
    ...
    Objectif
    --------
    Démontrer progressivement le comportement exprimé par `test_pytorch_is_available`.
    ...
    --------------------
    Cette specification TDD décrit le comportement attendu pour la section 1.1.
...
def test_cuda_tests_are_skipped_when_cuda_is_unavailable():
    ...
    Objectif
    --------
    Démontrer progressivement le comportement exprimé par `test_cuda_tests_are_skipped_when_cuda_is_unavailable`.
